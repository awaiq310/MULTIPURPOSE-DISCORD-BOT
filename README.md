...
├── handlers/ # Bot event handler system
├── idiomas/ # Language files
├── modelos/ # Models or templates
├── utils/ # Utility functions
├── config.json # Bot configuration (token, prefix, etc.)
├── index.js # Main bot file
├── ffmpeg-path.js # FFmpeg configuration for music
├── install-music.bat # Setup script for Windows
...
Copy code
npm install
Update config.json with your bot token and settings.
...
Copy code
node index.js
On Windows, run install-music.bat for automatic setup.

💡 Usage
Use the prefix defined in config.json to trigger commands.
